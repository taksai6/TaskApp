package jp.techacademy.takumi.nakamura.taskapp;
...
public class MainActivity extends AppCompatActivity {
    public final static String EXTRA_TASK = "jp.techacademy.takumi.nakamura.taskapp.TASK";
    ...
    private void all() {
        ...
        RealmResults<Task> result1 = mRealm.where(Task.class).findAllSorted("date", Sort.DESCENDING);
        mTaskRealmResults = result1;
        reloadListView();
    }
